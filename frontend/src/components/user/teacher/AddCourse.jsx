...
const AddCourse = () => {
   ...
   const handleSubmit = async (e) => {
      ...
      // Append top-level course details
      ...
      // Append each section with array-like structure
      addCourse.sections.forEach((section, index) => {
        ...
        if (section.S_content instanceof File) {
          ...
          formData.append(`S_content[${index}]`, "");
        }
      });
      ...
      try {
        ...
        if (error.response) {
          ...
          alert(`Server Error: ${error.response.data.message || 'An error occurred'}`);
